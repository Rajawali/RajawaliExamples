...
public class ColoredLineSegmentsRenderer extends RajawaliRenderer {
	public ColoredLineSegmentsRenderer(Context context)
	{
		super(context);
		setFrameRate(60);
	}
	...
	protected void initScene() {
		...
		for(int i=-1000; i<1000; i++)
		{
			...
			v.z = j * .01f;
			points.add(v);
			colors[colorCount++] = Color.argb(255, (int)(190.f * Math.sin(j)), (int)(190.f * Math.cos(j * .3f)), (int)(190.f * Math.sin(j * 2) * Math.cos(j)));
		}
		...
		TranslateAnimation3D camAnim = new TranslateAnimation3D(new Vector3(0, 0, 10), new Vector3(0, 0, -10));
