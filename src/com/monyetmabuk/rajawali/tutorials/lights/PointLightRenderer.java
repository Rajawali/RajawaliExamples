...
public class PointLightRenderer extends RajawaliRenderer {
	...
	protected void initScene() {
		...
		EllipticalOrbitAnimation3D anim = new EllipticalOrbitAnimation3D(new Vector3(0, 1, 0), new Vector3(1, 1, 1), 0, 359);
