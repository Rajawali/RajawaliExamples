...
public class RajawaliExamplesActivity extends ListActivity {
	private ExampleItem[] mItems = { 
			...
			new ExampleItem("Materials", RajawaliMaterialsActivity.class),
			...
			new ExampleItem("Bump Mapping", RajawaliBumpmapActivity.class),
			new ExampleItem("Bezier Path Animation", RajawaliBezierActivity.class), 
			new ExampleItem("Toon Shading", RajawaliToonShadingActivity.class),
			...
			new ExampleItem("Animated Sprites", RajawaliAnimatedSpritesActivity.class), 
			...
			new ExampleItem("Texture Compression (ETC)", RajawaliTextureCompressionActivity.class),
			new ExampleItem("Color Animation", RajawaliColorAnimationActivity.class),
			new ExampleItem("Scenes", RajawaliSceneActivity.class),
			new ExampleItem("Specular and Alpha Maps", RajawaliSpecularAndAlphaActivity.class),
			new ExampleItem("Video Texture", RajawaliVideoTextureActivity.class),
